...
public class RevenueProjection implements ReportCallback {
	String start = "";
	String end = "";
	int numsheets = 0;
	int numqueries = 0;
...
*************************************************************/
            ...
            sql = sql.replace("param1", fiscalDate);
            sql = sql.replace("param2", periodDate);
            sql = sql.replace("param3", companyId);
