...
DROP PROCEDURE IF EXISTS `socj_MarketSegment` $$
CREATE DEFINER=`bvu`@`10.100.4.13` PROCEDURE `socj_MarketSegment`(IN fromDate VARCHAR(50), IN toDate VARCHAR(50),IN company VARCHAR(50))
BEGIN
