...
DROP PROCEDURE IF EXISTS `socj_ProductACCO` $$
CREATE DEFINER=`bvu`@`10.100.4.13` PROCEDURE `socj_ProductACCO`(IN fromDate VARCHAR(50), IN toDate VARCHAR(50))
BEGIN
...
group by e.product_description ,e.branch_name#, j.socj_coid# v, socj_job
